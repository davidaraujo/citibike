...
public class RentalUris {
     ...
     */
    @JsonProperty("ios")
    @JsonPropertyDescription("URI that can be used on iOS to launch the rental app for this vehicle (added in v1.1).")
    private URI ios;
    /**
     ...
     */
    @JsonProperty("web")
    @JsonPropertyDescription("URL that can be used by a web browser to show more information about renting this vehicle (added in v1.1).")
    private URI web;
    @JsonIgnore
