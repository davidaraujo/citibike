...
public class Station__1 {
    ...
    public String toString() {
        ...
        sb.append(Station__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("stationId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Station__1) == false) {
            return false;
        }
        Station__1 rhs = ((Station__1) other);
