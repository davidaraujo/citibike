...
public class Data__10 {
    ...
    public String toString() {
        ...
        sb.append(Data__10 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("regions");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Data__10) == false) {
            return false;
        }
        Data__10 rhs = ((Data__10) other);
