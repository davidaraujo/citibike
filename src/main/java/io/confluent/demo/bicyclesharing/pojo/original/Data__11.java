...
public class Data__11 {
    ...
    public String toString() {
        ...
        sb.append(Data__11 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Data__11) == false) {
            return false;
        }
        Data__11 rhs = ((Data__11) other);
