...
public class FreeBikeStatus {
     ...
     */
    @JsonProperty("data")
    @JsonPropertyDescription("Array that contains one object per bike as defined below.")
    private Data data;
    @JsonIgnore
    ...
    public String toString() {
        ...
        sb.append(FreeBikeStatus.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
