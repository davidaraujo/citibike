...
public class GeofencingZones {
     ...
     */
    @JsonProperty("data")
    @JsonPropertyDescription("Array that contains geofencing information for the system.")
    ...
    public String toString() {
        ...
        sb.append(GeofencingZones.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof GeofencingZones) == false) {
            return false;
        }
        GeofencingZones rhs = ((GeofencingZones) other);
