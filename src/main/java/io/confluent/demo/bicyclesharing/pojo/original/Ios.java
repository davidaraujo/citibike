...
public class Ios {
    ...
    @JsonPropertyDescription("URI where the rental iOS app can be downloaded from (added in v1.1).")
    ...
    @JsonPropertyDescription("URI that can be used to discover if the rental iOS app is installed on the device (added in v1.1).")
    ...
    public String toString() {
        ...
        sb.append(Ios.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("storeUri");
        sb.append('=');
