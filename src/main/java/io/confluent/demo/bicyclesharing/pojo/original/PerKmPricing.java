...
public class PerKmPricing {
     ...
     */
    @JsonProperty("start")
    @JsonPropertyDescription("Number of kilometers that have to elapse before this segment starts applying (added in v2.1-RC2).")
     ...
     */
    @JsonProperty("rate")
    @JsonPropertyDescription("Rate that is charged for each kilometer interval after the start (added in v2.1-RC2).")
    private Double rate;
    /**
    ...
    @JsonPropertyDescription("Interval in kilometers at which the rate of this segment is either reapplied indefinitely, or if defined, up until (but not including) end kilometer (added in v2.1-RC2).")
     ...
     */
    @JsonProperty("end")
    @JsonPropertyDescription("The kilometer at which the rate will no longer apply (added in v2.1-RC2).")
    private Integer end;
    @JsonIgnore
    ...
    public String toString() {
        ...
        sb.append(PerKmPricing.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("start");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof PerKmPricing) == false) {
            return false;
        }
        PerKmPricing rhs = ((PerKmPricing) other);
