...
public class RentalUris__1 {
    ...
    public String toString() {
        ...
        sb.append(RentalUris__1 .class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("android");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof RentalUris__1) == false) {
            return false;
        }
        RentalUris__1 rhs = ((RentalUris__1) other);
