...
public class StationArea {
     ...
     */
    @JsonProperty("type")
    public StationArea.Type getType() {
        return type;
    }
     ...
     */
    @JsonProperty("type")
    public void setType(StationArea.Type type) {
        this.type = type;
    }
    ...
    public String toString() {
        ...
        sb.append(StationArea.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("type");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof StationArea) == false) {
            return false;
        }
        StationArea rhs = ((StationArea) other);
    ...
    public enum Type {
        ...
        private final static Map<String, StationArea.Type> CONSTANTS = new HashMap<String, StationArea.Type>();

        static {
            for (StationArea.Type c: values()) {
        ...
        @JsonCreator
        public static StationArea.Type fromValue(String value) {
            StationArea.Type constant = CONSTANTS.get(value);
            if (constant == null) {
