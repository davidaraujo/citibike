...
public class StationInformation {
     ...
     */
    @JsonProperty("data")
    @JsonPropertyDescription("Array that contains one object per station as defined below.")
    ...
    public String toString() {
        ...
        sb.append(StationInformation.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
