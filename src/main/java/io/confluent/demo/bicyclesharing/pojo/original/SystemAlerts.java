...
public class SystemAlerts {
     ...
     */
    @JsonProperty("data")
    @JsonPropertyDescription("Array that contains ad-hoc alerts for the system.")
    ...
    public String toString() {
        ...
        sb.append(SystemAlerts.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
