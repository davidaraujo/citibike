...
public class SystemCalendar {
    ...
    public String toString() {
        ...
        sb.append(SystemCalendar.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SystemCalendar) == false) {
            return false;
        }
        SystemCalendar rhs = ((SystemCalendar) other);
