...
public class SystemHours {
     ...
     */
    @JsonProperty("data")
    @JsonPropertyDescription("Array that contains system hours of operations.")
    private Data__7 data;
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public void setData(Data__7 data) {
        this.data = data;
    }
    ...
    public String toString() {
        ...
        sb.append(SystemHours.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof SystemHours) == false) {
            return false;
        }
        SystemHours rhs = ((SystemHours) other);
