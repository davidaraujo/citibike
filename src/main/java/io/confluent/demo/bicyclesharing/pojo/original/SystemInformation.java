...
public class SystemInformation {
     ...
     */
    @JsonProperty("data")
    public void setData(Data__8 data) {
        this.data = data;
    }
    ...
    public String toString() {
        ...
        sb.append(SystemInformation.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
