...
public class SystemPricingPlans {
     ...
     */
    @JsonProperty("data")
    @JsonPropertyDescription("Array that contains one object per plan as defined below.")
    private Data__9 data;
    @JsonIgnore
     ...
     */
    @JsonProperty("data")
    public void setData(Data__9 data) {
        this.data = data;
    }
    ...
    public String toString() {
        ...
        sb.append(SystemPricingPlans.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
