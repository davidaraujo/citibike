...
public class VehicleTypeCapacity {
    ...
    public String toString() {
        ...
        sb.append(VehicleTypeCapacity.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof VehicleTypeCapacity) == false) {
            return false;
        }
        VehicleTypeCapacity rhs = ((VehicleTypeCapacity) other);
